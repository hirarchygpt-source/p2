...
const BOOKS = [
  { isbn: "3234", title: "Magnolia Palace", author: "Fiona Davis", category: "Fiction", copies: 4, available: 2, shelf: "F-12", dateAdded: days(10) },
  { isbn: "1188", title: "Don Quixote", author: "Miguel de Cervantes", category: "Fiction", copies: 2, available: 0, shelf: "F-07", dateAdded: days(40) },
  { isbn: "0031", title: "Pride and Prejudice", author: "Jane Austen", category: "Fiction", copies: 3, available: 1, shelf: "F-03", dateAdded: days(150) },
  { isbn: "7711", title: "The Silent Patient", author: "Alex Michaelides", category: "Fiction", copies: 2, available: 1, shelf: "F-21", dateAdded: days(220) },
];
...
function InventoryContent() {
  ...
  const filtered = BOOKS.filter((b) => {
    ...
    const added = new Date((b as any).dateAdded).getTime();
    const matchesRange = !b.dateAdded || added >= now - threshold;
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
        <Input value={q} onChange={(e) => setSearch(e.target.value)} placeholder="Search ISBN, title, author, shelf..." />
